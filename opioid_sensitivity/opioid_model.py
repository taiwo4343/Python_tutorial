'''
This module specifies and solves (using RK45) the prescription opioid model
described in Battista, Pearcy, and Strickland (2019).
Running it from a command line will plot the solution using default parameter
values, as defined just below. The solver can also be called from another
module with custom parameters and solver arguments passed in.
'''
...
# default times to start/stop the model
tstart = 0
tstop = 10
